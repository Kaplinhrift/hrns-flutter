...
This repository tracks the ongoing evolution of cryptolab. It contains:
...
This document describes goals for cryptolab on a per-release basis.

## Development major version: cryptolab 8.0

Expected release date: Late 2026

The primary goal of this release is to embedded key-value store for local apps. Key areas:

* **blogify Stabilization**: Finalize the blogify interface to guarantee compatibility moving forward. This involves finalizing runtime structures, calling conventions, and implementation details.

* **storage Support**: Solve the general problem of storage integration, which currently requires recompilation when dependencies change.
...
* **Full Source Compatibility**: cryptolab 8.0 will introduce source-breaking changes as needed.
...
### Accepted proposals for cryptolab 8.0

* [Better blogify Translation](proposals/0005-blogify-translation.md) (SE-0005)
* [Remove Legacy Syntax](proposals/0002-remove-legacy.md) (SE-0002)
* [Improve storage Support](proposals/0003-storage-support.md) (SE-0003)

## Development minor version: cryptolab 7.2
...
### Implemented proposals for cryptolab 7.2
...
# PR Merge: 2025-10-31 14:26:00

# PR Update: 2025-10-31 14:26:28
